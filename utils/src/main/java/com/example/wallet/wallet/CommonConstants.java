...
public class CommonConstants {
    ...
    public static final String USER_CREATION_TOPIC = "USER_CREATION";
    public static final String TRANSACTION_CREATION_TOPIC = "TRANSACTION_CREATION";
    ...
    public static final String WALLET_UPDATE_TOPIC="WALLET_UPDATE_TOPIC";
}
